        ...
        <div className="min-h-[90vh] flex items-center justify-center pt-[100px] md:pt-0">
            <div className="w-[90%] md:flex justify-between items-center">
                <div className="w-full md:w-[50%] relative z-[99]">
                    <h2 className="text-3xl md:text-6xl text-center md:text-left md:leading-[60px] font-semibold text-textColor pb-2 md:pb-0">Optimiza tus Procesos Pesqueros con <span className="text-blueBtn font-bold">PescaBot</span> </h2>
                    <p className="py-4 text-lg text-center md:text-left ">Automatiza la gestión con SERNAPESCA y mejora la eficiencia operativa de tu empresa.</p>
